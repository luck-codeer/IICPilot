...
def run_container(
    ...
    # 从YAML文件加载Pod定义 
    os.chdir("/home/dell/jiangzesong/LLM/GPT4EDA_v2.0/agent") 
    with open(yaml_file, 'r') as f:  
        pod_yaml = f.read()  
    # 使用ApiClient的sanitize_for_serialization方法处理YAML内容  
    pod_body = yaml.safe_load(pod_yaml)
...
def prediction_source(
    ...
    eda_part: Annotated[str, "the specific eda part of the execution."],
    )->Annotated[str,"the CPU and RAM required for the specific rtl_desgin and eda_part"]:
    "Predict the resources required for container execution through RTL netlists and the EDA process utilized."
    
    # if rtl_design=="picorv32.v" and eda_part=="synthesis":
    #     cpu=1024
    #     ram=1024
    #     return cpu,ram
    # elif rtl_design=="picorv32.v" and eda_part=="floorplan":
    #     cpu=1024
    #     ram=1024
    #     return cpu,ram
    # elif rtl_design=="picorv32.v" and eda_part=="placement":
    #     cpu=1024
    #     ram=1024
    #     return cpu,ram
    # elif rtl_design=="picorv32.v" and eda_part=="routing":
    #     cpu=1024
    #     ram=1024
    #     return cpu,ram
    # elif rtl_design=="gcd.v" and eda_part=="synthesis":
    #     cpu=1024
    #     ram=1024
    #     return cpu,ram
    # elif rtl_design=="gcd.v" and eda_part=="floorplan":
    #     cpu=1024
    #     ram=1024
    #     return cpu,ram
    # elif rtl_design=="gcd.v" and eda_part=="placement":
    #     cpu=1024
    #     ram=1024
    #     return cpu,ram
    # elif rtl_design=="gcd.v" and eda_part=="routing":
    #     cpu=1024
    #     ram=1024
        return cpu,ram
...
EDA_process_implementation_agent = create_agent(
    llm,
    [read_file, write_file, run_eda_flow],
    '''You are an EDA_process_implementation agent who can generate scripts for the IC backend and pass information to the container agent and your response is the information that can be passed on.
     ...
     use the tool run_eda_flow to pass the return value of the tool to the the container agent.
...
container_agent = create_agent(
    llm,
    [create_container, delete_container, run_container, update_resources, prediction_source],
